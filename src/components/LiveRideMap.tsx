...
const LiveRideMap = ({ from, to, rideId, requestId, isDriver = false }: LiveRideMapProps) => {
  ...
  return (
    <div className="absolute inset-0 h-full w-full bg-[#eef1f4]">
      ...
      <div className="pointer-events-none absolute left-3 right-3 top-3 z-[999] flex items-start justify-between gap-2">
        <div className="pointer-events-auto rounded-2xl border border-black/15 bg-white/95 px-4 py-3 shadow-[0_12px_32px_rgba(17,24,39,0.12)] backdrop-blur-lg">
